...
if __name__ == "__main__":
    ...
    df.to_json(output_path + "\\train_results.json", orient='records')
    ...
    df.to_json(output_path + "\\test_results.json", orient='records')
    ...
    df.to_json(output_path + "\\val_results.json", orient='records')
