...
from mlp_functions import cp_plots, calculate_accuracy, kde2D, kde2D_pred, kde2D_scores

# Read training and testing data
df_train = pd.read_json("json\\train_results.json")
df_test = pd.read_json("json\\test_results.json")
df_val = pd.read_json("json\\val_results.json")
...
alphas_results_df.to_json("json\\alphas_results.json")
df_results = pd.read_json("json\\alphas_results.json", convert_axes=False)

cp_plots(df_results, "SAS-SSD", "MLP")
